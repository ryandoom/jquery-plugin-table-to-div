...
Conversion of the above table.  Right now it removes the spaces out of the heading rows, but a future change may be to remove any invalid characters for a class element.
  ...
  <div class="my_div_container">
    <div class="my_div_1">
      <div class="my_div_FirstName">Ryan</div>
      <div class="my_div_LastName">Doom</div>
      <div class="my_div_Company">Web Ascender</div>
      <div class="my_div_ImagePath">/whatever/something.jpg</div>
      <div class="my_div_Address">4151 Okemos Rd</div>
      <div class="my_div_Address2">STE B</div>
      <div class="my_div_City">Okemos</div>
      <div class="my_div_State">Michigan</div>
      <div class="my_div_Zip">48864</div>
    </div>
    <div class="my_div_2">
      <div class="my_div_FirstName">John</div>
      <div class="my_div_LastName">Doe</div>
      <div class="my_div_Company">Web Ascender</div>
      <div class="my_div_ImagePath">/images/whatever.jpg</div>
      <div class="my_div_Address">4151 Okemes Road.</div>
      <div class="my_div_Address2">STE B.</div>
      <div class="my_div_City">Okemos</div>
      <div class="my_div_State">MI</div>
      <div class="my_div_Zip">48864</div>
    </div>
  </div>
